...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sample_output_table = QtWidgets.QTableView(self.tab)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.selected_field_label.setText(_translate("MainWindow", "x1"))
        self.selected_info_label.setText(_translate("MainWindow", "The x-coordinate of the top-left point of a drawn rectangle."))
        self.label_4.setText(_translate("MainWindow", "Field information"))
        self.label_3.setText(_translate("MainWindow", "Sample output (up to 5 rects):"))
        self.label_2.setText(_translate("MainWindow", "Available fields/columns"))
        self.label.setText(_translate("MainWindow", "Selected fields/columns"))
        __sortingEnabled = self.selected_fields_list.isSortingEnabled()
        self.selected_fields_list.setSortingEnabled(False)
        item = self.selected_fields_list.item(0)
        item.setText(_translate("MainWindow", "x1"))
        item = self.selected_fields_list.item(1)
        item.setText(_translate("MainWindow", "y1"))
        item = self.selected_fields_list.item(2)
        item.setText(_translate("MainWindow", "x2"))
        item = self.selected_fields_list.item(3)
        item.setText(_translate("MainWindow", "y2"))
        self.selected_fields_list.setSortingEnabled(__sortingEnabled)
        __sortingEnabled = self.available_fields_list.isSortingEnabled()
        self.available_fields_list.setSortingEnabled(False)
        item = self.available_fields_list.item(0)
        item.setText(_translate("MainWindow", "x1_conv"))
        item = self.available_fields_list.item(1)
        item.setText(_translate("MainWindow", "y1_conv"))
        item = self.available_fields_list.item(2)
        item.setText(_translate("MainWindow", "x2_conv"))
        item = self.available_fields_list.item(3)
        item.setText(_translate("MainWindow", "y2_conv"))
        item = self.available_fields_list.item(4)
        item.setText(_translate("MainWindow", "overlaps"))
        item = self.available_fields_list.item(5)
        item.setText(_translate("MainWindow", "color"))
        item = self.available_fields_list.item(6)
        item.setText(_translate("MainWindow", "custom field"))
        self.available_fields_list.setSortingEnabled(__sortingEnabled)
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Table"))
        self.sample_output_raw.setPlainText(_translate("MainWindow", "x1,y1,33\n"
"sdfsdfsdfsdf\n"
"sdf\n"
"dfs\n"
"df"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Raw"))
        self.advanced_export_button.setText(_translate("MainWindow", "Export to .csv"))
