...
class Ui_AdvExportWindow(object):
    ...
    def retranslateUi(self, AdvExportWindow):
        ...
        self.selected_field_label.setText(_translate("AdvExportWindow", "x1"))
        self.selected_info_label.setText(_translate("AdvExportWindow", "The x-coordinate of the top-left point of a drawn rectangle."))
        ...
        item.setText(_translate("AdvExportWindow", "x1"))
        item = self.selected_fields_list.item(1)
        item.setText(_translate("AdvExportWindow", "y1"))
        item = self.selected_fields_list.item(2)
        item.setText(_translate("AdvExportWindow", "x2"))
        item = self.selected_fields_list.item(3)
        item.setText(_translate("AdvExportWindow", "y2"))
        ...
        item.setText(_translate("AdvExportWindow", "x1_conv"))
        item = self.available_fields_list.item(1)
        item.setText(_translate("AdvExportWindow", "y1_conv"))
        item = self.available_fields_list.item(2)
        item.setText(_translate("AdvExportWindow", "x2_conv"))
        item = self.available_fields_list.item(3)
        item.setText(_translate("AdvExportWindow", "y2_conv"))
        item = self.available_fields_list.item(4)
        item.setText(_translate("AdvExportWindow", "overlaps"))
        item = self.available_fields_list.item(5)
        item.setText(_translate("AdvExportWindow", "color"))
        item = self.available_fields_list.item(6)
        item.setText(_translate("AdvExportWindow", "custom field"))
