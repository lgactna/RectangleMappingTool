...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setMaximumSize(QtCore.QSize(580, 16777215))
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.tableView)
