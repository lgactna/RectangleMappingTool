...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drawing_area = QtWidgets.QWidget(self.centralwidget)
        ...
        self.drawing_area.setMinimumSize(QtCore.QSize(400, 300))
        self.drawing_area.setObjectName("drawing_area")
        self.gridLayout.addWidget(self.drawing_area, 0, 0, 1, 1)
