...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 479, 626))
        ...
        self.formLayout_2.setWidget(13, QtWidgets.QFormLayout.SpanningRole, self.label_23)
        ...
        self.formLayout_2.setLayout(14, QtWidgets.QFormLayout.SpanningRole, self.formLayout_3)
...
"    pass"))
        ...
        self.label_23.setText(_translate("MainWindow", "Note that changes to the canvas size are per-instance and are instantly reflected! They are not preserved across sessions and will not be saved."))
        ...
        self.label_14.setText(_translate("MainWindow", "If the canvas size is set to be a value larger than the loaded image, the image will (by default) remain unstretched and the canvas will grow to its size. You can change this option to stretch the image to the size of the canvas."))
        self.label_17.setText(_translate("MainWindow", "Stretch image to canvas."))
        self.label_18.setText(_translate("MainWindow", "If the canvas size is set to be smaller than the loaded image, the canvas will (by default) resize itself to match the new image. You can change this option to crop the image instead, anchored to the top-left."))
